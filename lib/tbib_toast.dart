...
class TBIBToastView {
  static final TBIBToastView _singleton = new TBIBToastView._internal();

  factory TBIBToastView() {
    return _singleton;
  }

  TBIBToastView._internal();
  ...
  static void createView(
    ...
    _overlayEntry = new OverlayEntry(
      builder: (BuildContext context) => TBIBToast(
          widget: Container(
...
class TBIBToast extends StatelessWidget {
  TBIBToast({
    Key? key,
